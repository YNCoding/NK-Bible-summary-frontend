      ...
      <main>
        <section>
          ...
          <article className={styles.article}>
            ...
            <label for="content EN"><h4>• summary of content:</h4></label>
            <textarea id="content EN" name="content EN" rows="10" cols="90">
            ...
            <label for="Content KR"><h4>• 내용요약:</h4></label>
            <textarea id="content KR" name="content KR" rows="10" cols="90">
